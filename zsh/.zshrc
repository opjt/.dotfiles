...
source /Users/pjt/.oh-my-zsh/powerlevel10k/powerlevel10k.zsh-theme
...
export DYLD_LIBRARY_PATH="/opt/oracle/instantclient_23_3"
export PATH="/opt/oracle/instantclient_23_3:$PATH"
export ORACLE_HOME="/opt/oracle/instantclient_23_3"

# pnpm
export PNPM_HOME="/Users/pjt/Library/pnpm"
case ":$PATH:" in
  *":$PNPM_HOME:"*) ;;
...
[[ -f ~/.kubectl-completion.zsh ]] && source ~/.kubectl-completion.zsh
